...
-- CreateEnum
CREATE TYPE "public"."FulfillmentStatus" AS ENUM ('NOT_REQUIRED', 'PENDING_DETAILS', 'READY_FOR_PRODUCTION', 'IN_PRODUCTION', 'READY_TO_SHIP', 'SHIPPED', 'DELIVERED', 'ON_HOLD', 'CANCELED');
...
CREATE TABLE "public"."Order" (
    ...
    "physicalRequired" BOOLEAN NOT NULL DEFAULT false,
    "shippingStatus" "public"."FulfillmentStatus" NOT NULL DEFAULT 'NOT_REQUIRED',
    "trackingNumber" TEXT,

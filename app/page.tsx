  ...
  return (
    <>
      <button
        ...
        className="fixed right-4 top-4 z-30 inline-flex rounded-full border border-stone-800/20 bg-white/70 px-4 py-2 text-xs font-semibold tracking-wide text-stone-800 shadow-md backdrop-blur transition hover:bg-white/90"
      >
        {showOverlay ? "Hide UI" : "Show UI"}
      </button>
      <SiteShell hideHeader={!showOverlay}>
        <HomeFloatingIslandCanvas
